...
class DependencyManager:
    ...
    def get_binary_path(self, tool_name):
        ...
        # We don't cache failures aggressively to allow runtime path updates, or we could.
        # But here we return the tool_name which will fail in subprocess.
        # Caching this result is fine as long as we clear cache on download.
    ...
    def download_dependencies(self, progress_callback=None):
        ...
        # Clear cache as we are about to add new binaries
